    ...
    <PageShell title="Collections">
      ...
      {showNew && (
        <div className="mb-6 p-5 bg-zinc-900 border border-zinc-800 rounded-lg space-y-3">
          ...
          <svg className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-zinc-400 w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
